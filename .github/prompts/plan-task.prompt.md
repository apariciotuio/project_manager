---
description: Analyze task, create specs with WHEN/THEN/AND scenarios, design decisions, propose division if large, auto-chain to plan-backend-task/plan-frontend-task
input:
  - task_id
---
