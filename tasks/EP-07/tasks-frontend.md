...
- [x] 5.3 [RED] Test: event type multi-select checkboxes; actor type filter; date range pickers; "Reset filters" clears all (2026-04-18 — 9 tests in __tests__/components/timeline/TimelineFilters.test.tsx)
- [x] 5.4 [GREEN] Implement `frontend/components/timeline/TimelineFilters.tsx` — fieldset/legend a11y, checkbox per event_type and actor_type, date range inputs, reset button (2026-04-18)
...
- [x] 5.7 [GREEN] Add Timeline page at `frontend/app/workspace/[slug]/items/[id]/timeline/page.tsx` — wires TimelineFilters + TimelineTab + client-side filter logic; TimelineEventType union extended with comment_deleted/version_created/review_submitted/export_triggered (2026-04-18)
