...
| **EP-22** | **Chat-first Capture Flow** (SplitView default, Dundun primer, section-suggestion bridge, Clarificación tab removed) | EP-02, EP-03, EP-04, EP-07, Dundun | Medium | ✅ Done 2026-04-18 (primer subscriber + WS proxy snapshot + signals validation + mig 0122 `primer_sent_at`; 42 tests; commits 0d4342b, 70e47b9, 19b8ece — pending Dundun team PRs to emit `suggested_sections` for useful UX) | ✅ Done 2026-04-18 (EP-22-lite Phases 1/6/7/8 + suggestion bridge Phases 2/3/4/5/9 + fixes; 50 tests) | [x] Proposal [x] Specs [x] Design [x] Tasks [x] Backend [x] Frontend |
